...
public final class Configure {
	...
	private  static  final  String ES_Ack="ack_IndexAlias";


	static {
		String profiles = System.getProperty("spring.profiles.active", "test");
		logger.info("=========================>>>>在什么环境启动？===>"+profiles);
		String fileName = "application-" + profiles +  ".properties";
	...
	public  static  String getES_Ack(){return PropertiesUtil.getValue(ES_Ack);}
